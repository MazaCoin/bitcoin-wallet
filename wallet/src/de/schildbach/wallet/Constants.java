...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "mazacoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

	public static final String BLOCKCHAIN_FILENAME = "blockchain" + FILENAME_NETWORK_SUFFIX;

	public static final String CHECKPOINTS_FILENAME = "checkpoints" + FILENAME_NETWORK_SUFFIX;

	private static final String EXPLORE_BASE_URL_PROD = "https://mazacha.in/";
	...
	public static final String USER_AGENT = "MazaCoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "MZC";
	public static final String CURRENCY_CODE_MBTC = "mMZC";
	...
	public static final String DONATION_ADDRESS = "MJkrkCVVujmAQVrHFDRY3bwPEQ7pEcLZba";
	public static final String REPORT_EMAIL = "Skirmant@gmx.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/mazacoin-project";
	public static final String BINARY_URL = "https://github.com/mazacoin-project";
	public static final String CREDITS_ZETACOINJ_URL = "https://github.com/mazazoin-project/mazacoinj";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = "https://bitcointalk.org/index.php?action=profile;u=2062";
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/Sk1rmant";
	...
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"\"";
